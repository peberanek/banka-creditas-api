...
class InlineResponse20024(object):
    ...
    @property
    def state(self):
        """Gets the state of this InlineResponse20024.  # noqa: E501

        Payment order state (PENDING, PROCESSED, FAILED, CANCELLED, AUTHORIZATION_REQUIRED)  # noqa: E501

        :return: The state of this InlineResponse20024.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this InlineResponse20024.

        Payment order state (PENDING, PROCESSED, FAILED, CANCELLED, AUTHORIZATION_REQUIRED)  # noqa: E501

        :param state: The state of this InlineResponse20024.  # noqa: E501
        :type: str
        """
